                ...
                <div class="modal-content">
                    ...
                    <form action="database.php" class="inventario" id="inventario" name="inventario" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <input class="form-control" type="text" name="suplidor" placeholder="Suplidor" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <input class="form-control" type="date" name="entrada" required>
                            </div>
                            <div class="mb-3">
                                <input class="form-control" type="date" name="salida" required>
                            </div>
                            <div class="mb-3">
                                <input class="form-control" type="date" name="expiracion" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button id="cancelAddToInventory" type="button" class="btn btn-danger"
                                data-bs-dismiss="modal">Cancelar</button>
                            <input class="btn btn-success" name="agregarAlInventario" type="submit" value="Agregar" />
                        </div>
                    </form>
                </div>
            </div>
